                                    ...
                                    <div class="row mt-20">
                                                ...
                                                <div class="col-md-4 col-lg-3">
                                                    <div class="product-item">
                                                        <div class="product-img">
                                                            ...
                                                            @endif
                                                            <a href="{{ route('frontend.document.details', $item->document->id) }}">
                                                                <img src="{{ asset($item->document->cover_image) }}" alt="{{ $item->document->title }}">
                                                            </a>
                                                        ...
                                                        <div class="product-content">
                                                            <h3 class="product-title">
                                                                <a href="{{ route('frontend.document.details', $item->document->id) }}">{{ $item->document->title }}</a>
                                                            </h3>
                                        ...
                                        @else
                                            <div class="col-12 text-center py-5">
                                                <h5>Chưa có tài liệu yêu thích nào.</h5>
                                            </div>
                                        @endif
                                    </div>
                                </div>
