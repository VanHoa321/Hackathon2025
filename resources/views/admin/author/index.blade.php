                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="#" class="text-info">Quản lý tác giả</a></li>
                            <li class="breadcrumb-item text-secondary">Danh sách tác giả</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div>   
                                    <a type="button" class="btn btn-success" href="{{route('author.create')}}">
                                        <i class="fa-solid fa-plus" title="Thêm mới tác giả"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($items as $item)
                                            <tr id="author-{{ $item->id }}">
                                                ...
                                                <td>
                                                    <a href="{{ route("author.edit", $item->id) }}" class="btn btn-info btn-sm" title="Sửa thông tin tác giả">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="{{ $item->id }}" title="Xóa tác giả">
