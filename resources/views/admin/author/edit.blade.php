                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('author.index') }}" class="text-info">Quản lý tác giả</a></li>
                            <li class="breadcrumb-item active">Cập nhật thông tin tác giả</li>
                        </ol>               
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("author.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                           
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="phone" class="form-control" placeholder="VD: 0349191354" value="{{old('phone', $edit->phone)}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Ngày sinh</label>
                                                        <input type="date" name="birth_date" class="form-control" value="{{old('birth_date', $edit->birth_date)}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
