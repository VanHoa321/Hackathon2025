                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="{{ route('tag.index') }}" class="text-info">Quản lý phân loại sản phẩm</a></li>
                            <li class="breadcrumb-item active">Chỉnh sửa phân loại</li>
                        </ol>               
                    </div>
                </div>
            </div>
                            ...
                            <form method="post" action="{{route("category.update", $edit->id)}}" id="quickForm">
                                ...
                                <div class="card-body">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="Nhập tên phân loại sản phẩm">
                                    </div>
                                    <div class="form-group">
            ...
            $('#quickForm').validate({
                ...
                messages: {
                    name: {
                        ...
                        minlength: "Tên phân loại phải có ít nhất {0} ký tự!",
                        maxlength: "Tên phân loại tối đa {0} ký tự!"
                    }             
                },
                errorElement: 'span',
