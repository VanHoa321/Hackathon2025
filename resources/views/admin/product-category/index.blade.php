                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            <li class="breadcrumb-item"><a href="#" class="text-info">Sản phẩm</a></li>
                            <li class="breadcrumb-item text-secondary">Phân loại sản phẩm</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($items as $item)
                                            <tr id="category-{{ $item->id }}">
                                                ...
                                                <td>
                                                    <a href="{{ route("category.edit", $item->id) }}" class="btn btn-info btn-sm" title="Sửa thông tin phân loại">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="{{ $item->id }}" title="Xóa phân loại">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                toastr.error('Có lỗi khi xóa phân loại');
                            }
                        });
                    }
                });
