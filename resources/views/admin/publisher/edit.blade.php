                ...
                <div class="row mb-2">
                    <div class="col-sm-6">         
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Chỉnh sửa thông tin nhà xuất bản</li>
                        </ol>               
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <form method="post" action="{{route("publisher.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                                
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{ old('name', $edit->name) }}" class="form-control" placeholder="VD: Nhà xuất bản Kim Đồng">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Thư điện tử</label>
                                                <input type="text" name="email" value="{{ old('email', $edit->email) }}" class="form-control" placeholder="VD: nxbkimdong123@gmail.com">
                                            </div>
                                        </div>                                             
                                    </div> 
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="phone" value="{{ old('phone', $edit->phone) }}" class="form-control" placeholder="VD: 0349191354">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Địa chỉ</label>
                                                <input type="text" name="address" value="{{ old('address', $edit->address) }}" class="form-control" placeholder="VD: Số 1, Nguyễn Thái Học, Đội Cấn, Ba Đình, Hà Nội">
                                            </div>
                                        </div>                                             
                                    </div>   
                                    <div class="form-group">
                                        <label>Địa chỉ website (nếu có)</label>
                                        <input type="text" name="website" value="{{ old('website', $edit->website) }}" class="form-control" placeholder="nxbkimdong.com.vn">
                                    </div>
                                    <div class="form-group">
