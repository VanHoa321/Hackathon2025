                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center p-1">
                                    <a href="{{ route('document.index') }}" class="btn btn-info btn-sm mx-2" title="Quay lại">
                                        <i class="fa-solid fa-rotate-left"></i> Quay lại
                                    </a>
                                    <a href="#" class="btn btn-success btn-sm mx-2" data-toggle="modal" data-target="#pdfPreviewModal">
