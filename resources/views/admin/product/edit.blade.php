                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <form method="post" action="{{route("product.update", $edit->id)}}" id="quickForm">
                                @csrf
                                <div class="card-body">                           
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Nhập tên sản phẩm" value="{{old('name', $edit->name)}}">
                                            </div>
                                            <div class="row">                                        
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Giá bán</label>
                                                        <input type="number" name="price" class="form-control" placeholder="Nhập giá bán sản phẩm" value="{{old('price', $edit->price)}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Giảm giá</label>
                                                        <input type="number" name="sale_price" class="form-control" placeholder="Nhập giảm giá sản phẩm" value="{{old('sale_price', $edit->sale_price)}}">
                                                    </div>
                                                </div>
                                            </div>   
                                            <div class="form-group">
                                                <label>Mô tả ngắn</label>
                                                <textarea class="form-control mb-3" name="abstract" placeholder="Nhập mô tả thêm" style="height: 60px">{{ old('abstract', $edit->abstract) }}</textarea>
                                            </div>                                                                          
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nội dung</label>
                                                <textarea id="summernote" class="form-control" name="content" placeholder="Nhập nội dung sản phẩm">{{ old('content', $edit->content) }}</textarea>
                                            </div>        
                                        </div>
                                    </div>
                                </div>
